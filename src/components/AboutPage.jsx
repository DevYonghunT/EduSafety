...
const WHY = [
  { icon: '⛰️', title: '우매함의 봉우리 문제', body: '바이브 코딩은 전문성 없이도 "작동하는 앱"을 즉시 만들어 줍니다. 화면이 돌아가는 순간 만든 사람은 자신이 무엇을 모르는지 모르는 지점에 서게 되고, 절벽 아래에 있는 것은 학생의 개인정보입니다.' },
...
const FLOW = [
  ...
  { step: '②', title: '앱 확인', body: '앱의 기능(학생 대면·개인정보 수집·평가 기능 등)을 심사자가 확인하면, 적용될 심사 항목과 보호 수준(L0~L2)이 자동으로 정해집니다. AI가 기능 확인을 제안할 수 있지만 확정은 심사자가 합니다.' },
